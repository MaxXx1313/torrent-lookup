  ...
  <main class="flex-1 flex flex-col overflow-y-auto">
    ...
    <div class="max-w-4xl mx-auto w-full px-8 py-10">
        ...
        <div class="flex flex-col gap-4">
          <div class="flex justify-between items-end">
            <div class="flex flex-col gap-1">
              ...
              <p class="text-slate-500 dark:text-[#92adc9] text-sm font-normal">Current: <span class="text-primary">/downloads/movies/Interstellar.2014.1080p.mkv</span></p>
            </div>
          ...
          <div class="h-3 w-full rounded-full bg-slate-100 dark:bg-[#324d67] overflow-hidden">
            <div class="h-full rounded-full bg-primary transition-all duration-500 shadow-[0_0_15px_rgba(19,127,236,0.4)]" style="width: 75%;"></div>
          </div>
        </div>
      </div>
      <!-- Live Log / Summary -->
      ...
      <div class="bg-white dark:bg-[#1a2632] border border-slate-200 dark:border-[#233648] rounded-xl overflow-hidden">
        <div class="px-6 py-4 border-b border-slate-200 dark:border-[#233648] flex justify-between items-center bg-slate-50 dark:bg-[#1c2a38]">
          <h3 class="text-slate-900 dark:text-white font-bold text-sm uppercase tracking-wide">Export Activity Log</h3>
          <span class="text-xs px-2 py-1 rounded bg-slate-200 dark:bg-[#233648] text-slate-600 dark:text-[#92adc9]">Live</span>
        </div>
        <div class="p-4 h-48 overflow-y-auto custom-scrollbar font-mono text-xs flex flex-col gap-2">
          <div class="flex gap-3 text-emerald-500">
            <span>[14:22:01]</span>
            <span>SUCCESS: Linked "Blade.Runner.2049.2160p.mkv" to qBittorrent</span>
          </div>
          <div class="flex gap-3 text-emerald-500">
            <span>[14:22:05]</span>
      ...
      <div class="mt-12 pt-12 border-t border-slate-200 dark:border-[#233648]">
        <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-8 flex flex-col items-center text-center">
          <div class="w-16 h-16 rounded-full bg-emerald-500 flex items-center justify-center text-white mb-4 shadow-lg shadow-emerald-500/20">
            <span class="material-symbols-outlined text-4xl">check_circle</span>
          </div>
          <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-2">Export Successfully Completed</h2>
          <p class="text-slate-600 dark:text-[#92adc9] mb-8 max-w-md">All selected torrents have been successfully mapped and added to your client. You can now start seeding.</p>
          ...
          <div class="flex flex-col sm:flex-row gap-3 w-full justify-center">
            ...
            <button class="bg-slate-200 dark:bg-[#233648] hover:bg-slate-300 dark:hover:bg-[#324d67] text-slate-900 dark:text-white font-bold py-3 px-8 rounded-lg transition-all flex items-center justify-center gap-2">
